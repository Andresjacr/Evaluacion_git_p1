...
1. **Crear Hasta 10 Ramas para los Tipos de Ejercicio**
...
1. **Agregar una Entrada para Cada Ejercicio con Múltiples Commits**
...
1. **Repetir para Cada Tipo de Ejercicio**
...
1. **Fusionar Cada Rama a la Rama Principal (**`**main**`**)**
